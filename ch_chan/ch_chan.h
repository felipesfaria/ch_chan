...
public:
    ...
    static void FindLeftmostHull(vector<vector<Point_2> > hulls, int &hIndex, int &pIndex);
    static int Rtangent_PointPolyC(Point_2 P, vector<Point_2> V);
    static void NextPair(vector<vector<Point_2> > hulls, int &hIndex, int &pIndex);
};
